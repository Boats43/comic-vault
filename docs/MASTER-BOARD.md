...
**Phase A: HOLD** until explicitly opened by a future dispatch. No migration `0013` written. No schema or source code touched by any of the Phase 0, Schema Ruling, or A6/A7 refinement passes — all fully docs-only. Milestone Ten unaffected, remains OPEN / PHYSICAL-CROSS-DEVICE-PENDING.
