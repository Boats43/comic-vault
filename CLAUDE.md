...
- **Test baseline:** 203 PASS / 19 FAIL / 4 TIMEOUT / 226 total — HEAD (this commit), 2026-08-21 (GK-148, publisher stop-list). Prior 202/19/4/225 (GK-145/146). One new file, fully passing: `grailkey-gk148-publisher-stoplist.test.js` (12/12 — direct Creepy #1 repro, B2-extended 210-check publisher-corpus proof, real handler smoke). FAIL/TIMEOUT list byte-identical to the prior baseline (same 19 named files, same 4 named files). Full history: Pattern Library "GrailKey Dispatch 2026-08-21."
