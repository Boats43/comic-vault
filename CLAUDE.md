...
End-to-end verification on D'Orc #1 (Image 2026 NM 9.4, stored year 2025): 2 comps → 5 comps, price $275.49 → $109 range with priceNote "PC outlier — eBay avg used" and `yearCorrected: true` / `confirmedYear: 2026`. Key mult no longer stacks on browse_api source.
