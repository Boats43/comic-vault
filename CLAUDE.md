...
**Test baseline (current):** 222 PASS / 19 FAIL / 4 TIMEOUT / 245 total — HEAD, 2026-08-22 (GK-159). FAIL/TIMEOUT list confirmed byte-identical in composition to the prior stamp — zero new regressions.
**Immediate predecessor:** 220 PASS / 19 FAIL / 4 TIMEOUT / 243 total — 2026-08-22 (GK-157/158). Full cascade (six prior stamps, verbatim, with per-dispatch evidence): `docs/TEST-BASELINE-HISTORY.md`. **Standing rule: re-stamp the current-baseline line in the same commit as any test-file add/remove.**
