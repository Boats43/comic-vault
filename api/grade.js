...
const JSON_SHAPE =
  '{ "title": string, "issue": string, "publisher": string, "year": string, "foreignEdition": boolean, "grade": string, "isGraded": boolean, "numericGrade": number or null, "certNumber": string or null, "labelType": "universal" or "qualified" or "restored" or "conserved" or "signature" or null, "labelNotes": string or null, "keyIssue": string or null, "variant": string or null, "creator": string or null, "price": string, "priceLow": string, "priceHigh": string, "reason": string, "confidence": string, "detectedPrice": string or null, "restoration": string or null, "defectPenalty": number or null, "cgcPenaltyFlags": { "storeStamp": { "detected": boolean, "pedigreeName": string or null }, "staplePopping": { "detected": boolean, "severity": "minor" or "severe" or null }, "polybagIndents": { "detected": boolean }, "cornerChips": { "detected": boolean, "count": number or null }, "pedigreeStamp": { "detected": boolean, "pedigreeName": string or null } } or null }';
