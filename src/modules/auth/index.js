...
// src/modules/auth/ may import. Re-exports login/loginWithExternalIdentity/
// verifyToken and the error classes — nothing else. repository.js, db.js,
// token.js, and credentials.js are never re-exported here and never
...
export { login, loginWithExternalIdentity, verifyToken } from './service.js';
